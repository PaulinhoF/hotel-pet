**Trabalho Final - Hotel Pet**   

  
O projeto da disciplina será criar um site chamado [**Hotel Pet**](https://www.figma.com/design/N8XRn6aNIH9PyiGr7LUBYb/Lo-fi-Wireframe-Kit--Community-?node-id=2196-8620&p=f) (Clique no link para o Figma).
O projeto deverá ser desenvolvido individualmente utilizando, primeiramente, **HTML e CSS**. 

**O CSS no Figma é neutro, Vocês personalizarão as cores e Imagens.**
